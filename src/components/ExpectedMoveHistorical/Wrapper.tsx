...
import { Stack, FormControl, InputLabel, Select, MenuItem, Divider, Checkbox, Tooltip, Box, Typography, ToggleButtonGroup, ToggleButton, Paper } from "@mui/material";
            ...
            <Stack direction="row" gap={1} p={1} alignItems="center">
                ...
                <FormControl size="small" sx={{ width: 24 }}>
                    <Tooltip title="Magnet Mode">
                        ...
                        }} icon={<AdfScannerOutlinedIcon />} checkedIcon={<AdfScannerIcon />}
                            checked={magnetMode} onChange={(e) => setMagnetMode(e.target.checked)} />
                    </Tooltip>
                </FormControl>
                <Divider orientation="vertical" variant="middle" flexItem />
