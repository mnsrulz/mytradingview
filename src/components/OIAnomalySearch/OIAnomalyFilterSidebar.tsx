...
export const OIAnomalyFilterSidebar = () => {    
    return <Paper elevation={1} sx={{ minWidth: 220, p: 2 }}>
        ...
        <RefinementList title='Data Mode' attribute="dt" sortBy={['name:desc']} searchable={true} showMore={true} limit={5} />
        <Divider sx={{ my: 2 }} />
        <RefinementList title='Symbols' attribute="option_symbol" searchable={true} searchablePlaceholder='Search symbols...' showMore={true} limit={10} />
        <Divider sx={{ my: 1 }} />
        <Typography variant='button'>Expiration</Typography>
        <RefinementList title='Expiration' attribute="expiration" sortBy={['name:asc']} searchable={true} showMore={true} limit={5} />
        <Divider sx={{ my: 2 }} />
