...
export const OptionsPricingGrid = (props: OptionsPricingGridProps) => {
    const { rows, workingStrikes, valueMode, onExpiryClick } = props;
    ...
    const columns: GridColDef[] = [
        ...
        ...strikeColumns.map(col => ({
            ...col,
            renderCell: conditionalFormatting.enabled
                ? (p: GridRenderCellParams) => <ConditionalFormattingBox value={p.value * conditionalFormatting.multiplier} formattedValue={p.formattedValue} />
                : undefined
        }))
    ];
